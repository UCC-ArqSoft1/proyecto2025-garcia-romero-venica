      ...
      <div className="admin-secciones">
        ...
        <div className="admin-bloque">
          ...
          <div className="admin-formulario">
            ...
            ></textarea>
            {modoEdicion ? (
              <button onClick={handleActualizarActividad}>Actualizar Actividad</button>
            ) : (
              <button onClick={handleAgregarActividad}>Agregar Actividad</button>
            )}
          </div>
        </div>

        {/* Sección derecha: Editar */}
        <div className="admin-bloque">
