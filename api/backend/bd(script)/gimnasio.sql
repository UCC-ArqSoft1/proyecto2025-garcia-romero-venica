...
CREATE TABLE `actividades` (
  ...
  KEY `fk_id_catego_idx` (`id_categoria`),
  CONSTRAINT `fk_id_catego` FOREIGN KEY (`id_categoria`) REFERENCES `categoria_actividades` (`idcategoria`)
...
CREATE TABLE `horarios` (
  ...
  KEY `fk_activi_id_idx` (`actividad_id`),
  CONSTRAINT `fk_activi_id` FOREIGN KEY (`actividad_id`) REFERENCES `actividades` (`id_actividades`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inscripciones` (
  ...
  KEY `fk_horario_id_idx` (`horario_id`,`usuario_id`),
  CONSTRAINT `fk_horar_id` FOREIGN KEY (`horario_id`) REFERENCES `horarios` (`id_horarios`),
...
-- Dump completed on 2025-05-14 23:00:44
